...
\subsection{Comparision des fonction de grazing diffèrents}
...
\begin{figure}[h]
  ...
  \caption{Les simulations de références pour les fonctions diffèrents de grazing (
...
Holling (eq.~\ref{eq:partie1GrazHol}, ligne terminale)) pour des temps final diffèrents.
