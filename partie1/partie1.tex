...
%phytoplancton (terme croissance > terme mortalité) persiste de $t=0$ à $t\approx 18$ jours
%(voir table~\ref{tab:partie1appPropFctGrazing}). Avant d'atteindre
%le max (terme croissance = terme mortalité) qui vaut 60 mmol/m3. Après ce max, la concentration en
%phytoplancton diminue car le terme de mortalité > terme de croissance, jusqu'à atteindre un min à
%28 jours à une concentration de 3. En effet, au début, il n'y a que très peu de MSZ (concentration
%bien plus faible que DA initial). Ainsi, la croissance du phyto va entrainer une croissance du zoo
%(terme grazMSZ augmente selon DA^2). Cette augmentation de MSZ va faire qu'on aura terme croissance
%DA = terme mortalité DA. Puis comme DA diminue, MSZ fini par diminuer jusqu'à un minimum à 65 jours
%à une concentration de 8. Après le minimum de DA, la population de DA va réaugmenter car comme DA
%faible, le terme grazing est faible et donc le terme croissance reprend le dessus. Les deux pop
%finissent par s'équilibrer après 80 jours. 
}
...
\clearpage
\subsubsection{Test 2 - Augmonter le demi-saturation des mésozooplancton}
\begin{figure}
...
\clearpage
\subsubsection{Test 3 - Diminuer le demi-saturation des mésozooplancton}
\begin{figure}
...
\clearpage
\subsubsection{Test 4 - Augmontation de l'efficacité de grazing}
\begin{figure}
...
\clearpage
\subsubsection{Test 5 - Diminer la mortalité des mésozooplanctons}
\begin{figure}
...
\end{figure}
\par{
Taux de mortalité plus faible, donc le zoo va diminuer moins rapidement que dans la ref. De plus, puisque
le taux est plus faible, plus de MSZ et donc, la concentration de DA est plus faible et est atteinte plus
rapidement.
}
\FloatBarrier
